...
<body>
	...
	<div class="container">
		<form name="newMeber" class="form-horizontal" action="processAddMember.jsp" method="post" onsubmit="return checkForm()">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="password_confrim" type="password" class="form-control" placeholder="password confirm">
				</div>
			</div>
			<div class="form-group  row">
